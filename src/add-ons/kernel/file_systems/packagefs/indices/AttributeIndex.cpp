...
AttributeIndexer::CreateCookie(IndexedAttributeOwner* owner,
	void* attributeCookie, uint32_t attributeType, size_t attributeSize,
...
status_t
AttributeIndex::Init(Volume* volume, const char* name,  uint32_t type,
	size_t keyLength)
{
...
void
AttributeIndex::NodeChanged(Node* node, uint32_t statFields,
	const OldNodeAttributes& oldAttributes)
{
...
void
AttributeIndex::Iterator::NodeChanged(Node* node, uint32_t statFields,
	const OldNodeAttributes& oldAttributes)
{
