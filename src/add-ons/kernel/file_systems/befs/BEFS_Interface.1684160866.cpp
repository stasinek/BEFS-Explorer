...
//static 
status_t
bfs_read_dir(void* _ns, void* _node, void* _cookie, struct dirent_t* Dirent, 
...
//static 
status_t
bfs_read(void* _ns, void* _node, void* _cookie, int64_t pos, void* buffer, int64_t* _length)
{
...
//-----------------------------------------------------------------------------
status_t
bfs_read_attr_dir(void* _ns, void* node, void* _cookie, struct dirent_t* dirent,
	size_t bufferSize, uint32_t* _num)
{
	//FUNCTION();
	AttributeIterator* iterator = (AttributeIterator* )_cookie;
...
//-----------------------------------------------------------------------------
status_t
bfs_read_attr(void* _fs, fs_vnode _file, attr_cookie* _cookie, int64_t pos,
	void* buffer, int64_t* _length)
{
	//FUNCTION();
