...
inline
CachedBlock::CachedBlock(Volume *volume, int64_t block)
	:
	fVolume(volume),
	fBlockNumber(0),
	fBlock(NULL)
...
CachedBlock::SetTo(int64_t block, int64_t base, size_t length)
{
	Unset();
	fBlockNumber = block;
...
inline const uint8_t *
CachedBlock::SetTo(int64_t block)
{
...
inline uint8_t *
CachedBlock::SetToWritable(Transaction &transaction, int64_t block, int64_t base, size_t length, bool empty)
{
	Unset();
	fBlockNumber = block;
...
inline uint8_t *
CachedBlock::SetToWritable(Transaction &transaction, int64_t block, bool empty)
{
