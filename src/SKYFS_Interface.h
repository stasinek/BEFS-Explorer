...
#include <WINNT_Defs.h> //for Windows API
...
status_t skyfs_read_dir(void *_ns, void *_node, void *_cookie, struct dirent_t *Dirent, size_t bufferSize, uint32_t *_num);
...
status_t skyfs_read_attr_dir(void *_ns, void *node, void *_cookie, struct dirent_t *dirent, size_t bufferSize, uint32_t *_num);
