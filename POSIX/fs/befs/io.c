 ...
 *
 * Based on portions of file.c and befs_inode.c 
...
struct buffer_head*
befs_bread_iaddr(befs_super_block* sb, befs_inode_addr iaddr)
{
...
struct buffer_head*
befs_bread(befs_super_block* sb, befs_blocknr_t block)
{
	struct buffer_head *  bh = NULL;
	befs_sb_info* befs_sb = BEFS_SB(sb);
