...
static inline u64 fs64_to_cpu(const befs_super_block *sb, u64 n)
{
...
static inline u64 cpu_to_fs64(const befs_super_block *sb, u64 n)
{
	if (BEFS_SB(sb)->byte_order == BEFS_BYTESEX_LE)
...
static inline u32 fs32_to_cpu(const befs_super_block *sb, u32 n)
{
	if (BEFS_SB(sb)->byte_order == BEFS_BYTESEX_LE)
...
static inline u32 cpu_to_fs32(const befs_super_block *sb, u32 n)
{
	if (BEFS_SB(sb)->byte_order == BEFS_BYTESEX_LE)
...
static inline u16 fs16_to_cpu(const befs_super_block *sb, u16 n)
{
	if (BEFS_SB(sb)->byte_order == BEFS_BYTESEX_LE)
...
static inline u16 cpu_to_fs16(const befs_super_block *sb, u16 n)
{
	if (BEFS_SB(sb)->byte_order == BEFS_BYTESEX_LE)
...
static inline befs_block_run fsrun_to_cpu(const befs_super_block *sb, 
		befs_block_run n)
{
	befs_block_run run;
...
static inline befs_block_run cpu_to_fsrun(const befs_super_block *sb, 
		befs_block_run n)
{
	befs_block_run run;
...
static inline befs_data_stream fsds_to_cpu (const befs_super_block *sb, 
		befs_data_stream n)
{
