...
#ifndef BFS_INTERFACE_H
#define BFS_INTERFACE_H

#include "BOS_System_Dependencies.h"
#include "BFS_Attribute.h" //for struct attr_cookie
...
status_t bfs_read(void *_ns, void *_node, void *_cookie, uint64 pos, void *buffer, uint64 *_length);
...
status_t bfs_read_attr(void* _fs, fs_vnode _file, attr_cookie* _cookie, uint64 pos, void *buffer, uint64 *_length);
