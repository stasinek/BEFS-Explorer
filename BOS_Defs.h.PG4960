...
struct fs_info {
    ...
    uint64   block_size;                         /* fundamental block size */
    uint64   io_size;                            /* optimal io size */
    uint64   total_blocks;                       /* total number of blocks */
    uint64   free_blocks;                        /* number of free blocks */
    uint64   total_nodes;                        /* total number of nodes */
    uint64   free_nodes;                         /* number of free nodes */
...
struct stat {
	...
	uint64			st_size;		/* size in bytes of this file */
...
typedef struct iovec{
	...
	//uint64        iov_len;   /* size of the data storage area in bytes */
} iovec;
#ifndef addr_t
typedef char* addr_t;
#endif
